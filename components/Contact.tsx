...
export function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative py-24 md:py-36 bg-[#030507] overflow-hidden"
    >
      {/* Dot grid background */}
      <div
      ...
      <div ref={ref} className="relative z-10 max-w-6xl mx-auto px-6">
        <div
          className="grid md:grid-cols-2 gap-6 md:gap-24 items-start"
          dir={dir}
        >
          {/* ── LEFT: Info column ── */}
          <motion.div
          ...
          >
            ...
            >
              <div
                className="w-8 h-8 rounded-lg border border-blue-500/30 bg-blue-500/[0.08]
              ...
              <span className="text-white/25 group-hover:text-blue-400 text-sm transition-colors duration-200">
                →
              </span>
            </motion.a>
